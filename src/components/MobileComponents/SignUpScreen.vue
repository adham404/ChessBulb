  ...
  <div class="white">
    ...
    <v-container rounded class="pt-0">
      ...
      <v-text-field label="First name" outlined rounded v-model="FirstName"
        >hello</v-text-field
      >
      <v-text-field label="Last name" outlined rounded v-model="LastName"
        >hello</v-text-field
      >
      <v-text-field
        label="Email"
      ...
      ></v-text-field>
      <v-row>
        <v-checkbox v-model="checkbox" class="mt-0 ml-4"></v-checkbox>
        <span class="text-subtitle-2 mt-1">
          I agree to
          <a href="javascript:void(0);" id="privacy"
