//TODO add sure functional (10min) //TODO uplaoad the video to firebase storge
(10min) //TODO disable closing the page and make all routes open in new
window(20min) //FIXME how to make routes open in new tab //TODO dispaly the est
time for upload and the persanteg (12 min) //TODO add the pgn file and the time
samp objects to the firestore doc (10min) //TODO add the video link and corse
