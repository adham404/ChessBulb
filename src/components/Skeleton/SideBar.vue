    ...
    <div class="SideBar">
        <div id="links">
            ...
            <router-link to="/Courses">
                <svg xmlns="http://www.w3.org/2000/svg" width="39.503" height="32.321" viewBox="0 0 39.503 32.321">
                    <path id="Icon_material-school" data-name="Icon material-school" d="M8.682,22.779v7.182l12.569,6.859,12.569-6.859V22.779L21.251,29.638ZM21.251,4.5,1.5,15.274,21.251,26.047l16.16-8.816V29.638H41V15.274Z" transform="translate(-1.5 -4.5)" fill="#fff"/>
                </svg>
            </router-link>
            <router-link to="/Academies">
                <svg xmlns="http://www.w3.org/2000/svg" width="35.5" height="40.391" viewBox="0 0 35.5 40.391">
            ...
            <router-link to="/Play">
                <svg xmlns="http://www.w3.org/2000/svg" width="35.257" height="39.885" viewBox="0 0 35.257 39.885">
        ...
        <div id="controls">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="34.875" height="34.875" viewBox="0 0 34.875 34.875">
                <path id="Icon_awesome-redo-alt" data-name="Icon awesome-redo-alt" d="M18.032.563A17.378,17.378,0,0,1,30.046,5.392l2.511-2.511a1.688,1.688,0,0,1,2.881,1.193V13.5a1.687,1.687,0,0,1-1.687,1.688H24.324a1.688,1.688,0,0,1-1.193-2.881l2.936-2.936a11.812,11.812,0,1,0-.288,17.519.842.842,0,0,1,1.151.039l2.789,2.789a.845.845,0,0,1-.034,1.226A17.438,17.438,0,1,1,18.032.563Z" transform="translate(-0.563 -0.563)" fill="#fff"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="31.5" height="20.531" viewBox="0 0 31.5 20.531">
