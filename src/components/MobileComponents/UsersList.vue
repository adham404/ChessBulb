...
export default {
  ...
  computed: {
    ...mapGetters([
      "GetTenUsersTillTheSearchEngineWorksFine",
      "GetUsersDataforUserListCards"
    ])
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions([
      "fetchUsersTillTheSearchEngineWorksFine",
      "fetchUsersFromSearchEngine"
    ]),
    GetUserData(ids) {
      this.UserDataList = [];
