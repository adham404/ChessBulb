<template>
  <!-- <div class="ChessEngine" > -->
      <v-sheet color="primary" min-height="20%"  width="95%" class="ml-2 mt-2 mb-2" rounded = "lg">
      <v-chip-group
      class="pl-2"
      column>
      <!-- <p v-if="loading" > Loading...</p> -->
      <v-skeleton-loader  dark  v-if="loading" class="py-1 mx-1" type="chip" ></v-skeleton-loader>
      <v-skeleton-loader  dark  v-if="loading" class="py-1 mx-1" type="chip" ></v-skeleton-loader>
      <v-chip   v-for="(line,index) in lines" :key="index" @click="emitmove(line.move)" >
