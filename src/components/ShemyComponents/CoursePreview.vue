...
<div>
    ...
    //TODO Under the Left DIV put [Reviews] and pass (CourseData.ID) (5min)
    //TODO Under [Reviews] put [Rate] and pass Boolean Value (PreviewFlag) (5min)
    //TODO Right To the Left DIV put [AboutInstructor] and pass (CourseData.ID) (5min) 
