      ...
      <v-sheet class="my-8">
        ...
        <v-sheet class="mt-8 py-3">        
            ...
            <v-row v-if="MoveClicked" justify="space-around" class="my-1">
                <v-btn @click="OverWriteMove" rounded class="primary">OverWrite Old Move</v-btn>
            ...
            <div style="height: 200px; overflow-y: scroll">
                ...
                <div style="color:white" v-for="(WhiteMove, x) in Line.WhiteMoves" v-bind:key="x">
                    <div style="color:white" @click="WhiteMoveClicked(Line.Line,WhiteMove)">{{WhiteMove}}</div>
                </div>
              </div>
              <div class="ColorCol">
              <div>Black Moves</div>
...
export default {
    ...
    mounted()
    {
        ...
        this.ChessMoveObject[this.LineCounter].ChessEngine = new Chess(this.GetChessBoardStartingPositionForSnapshots);
    ...
    OpenLine()  //This Function to Create a new Line 
    {
      ...
      var SolutionLine = this.ChessMoveObject.length;
        ...
        this.ChessMoveObject[SolutionLine].ChessEngine = new Chess(this.GetChessBoardStartingPositionForSnapshots);
