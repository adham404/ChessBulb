  ...
  <div> 
    <div class="NewsFeedPgn font-weight-light">
      ...
      <span v-for="(i, index) in pgnoutput" :key="index">
        <span class="font-weight-medium text-subtitle-2" style="color: white">{{ i.number }}.</span>
        <span class="font-weight-medium text-subtitle-2" style="color: white" id="pgnmove" @click="moveto(i.move1num)">{{ i.move1 }} </span>
        <span class="font-weight-medium text-subtitle-2" style="color: white">{{ i.comment1 }} </span>
        <span class="font-weight-medium text-subtitle-2" style="color: white" id="pgnmove" @click="moveto(i.move2num)">{{ i.move2 }} </span>
        <span class="font-weight-medium text-subtitle-2" style="color: white">{{ i.comment2 }} </span>
      </span>
    </div>
  </div>
</template>
